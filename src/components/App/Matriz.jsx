export const Matriz = ({iconComponent,sysNumber=2, constants={a1:'a1',a2:'a2',a3:'a3',b1:'b1',b2:'b2',b3:'b3',c1:'c1',c2:'c2',c3:'c3'}}) => {
    return (
        <div className="flex text-white mt-5 items-center gap-2 ">
            ...
            = {`{
                  [ (${constants.a1}.${constants.b2}.${constants.c3}) + 
                    (${constants.b1}.${constants.c2}.${constants.a3}) +
                    (${constants.c1}.${constants.a2}.${constants.b3})
                  ] -
                  [ (${constants.a3}.${constants.b2}.${constants.c1}) + 
                    (${constants.b3}.${constants.c2}.${constants.a1}) +
                    (${constants.c3}.${constants.a2}.${constants.b1})
                  ] 
            }
             `}
                </>
