...
export const Equation2Sys=()=>{
    ...
    return(
        <div className="bg-[#333] p-3 rounded flex flex-col w-[80vw] h-[60vh] overflow-y-scroll">
            ...
            <h2 className="text-start text-white text-2xl">a1x + b1y = c1</h2>
            <h2 className="text-start text-white text-2xl">a2x + b2y = c2</h2>
            </div>
            <div className="grid grid-cols-3 grid-rows-2 gap-3 mt-8">
                ...
                <input name="c1" type="number" value={mathState.sys2Constants.c1} onChange={constsHandler} className="p-1 sm:p-2 rounded bg-white text-black w-[100%]" placeholder="c1"  />
                </div>
                ...
                <div className="text-white flex items-center gap-2"><span className="text-2xl">=</span>
                <input name="c2" type="number" value={mathState.sys2Constants.c2} onChange={constsHandler} className="p-1 sm:p-2 rounded bg-white text-black w-[100%]" placeholder="c2"  />
                </div>
            </div>
