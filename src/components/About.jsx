...
export const About=()=>{
    ...
    <div className="h-100 w-100 sm:w-[100%]  fixed left-3 top-30">
        ...
        <div className="h-[250px] w-[100%] mt-10 sm:mt-5   sm:gap-5  sm:grid sm:grid-cols-[80fr_20fr] p-4">
           
            <div className="text-start w-[80%] text-white  h-50 flex flex-col justify-center p-1">
